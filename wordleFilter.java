...
public class wordleFilter {
    ...
    public static void filter(char ch, int pos){
        //to-do filter mechanism
        /*
            **functionality**
            1. receive letter ch 
            2. receive number pos
                (a) if(pos > 0 && pos < 6){} -> ch is at position (pos-1)
                (b) if(pos == 0) -> ch is somewhere in the word
                (c) if(pos == -1) -> ch is NOT in the word
                (d) <pos of letter included but not at a particular position (?)>
            3. if (a) or (b) (or (d)) -> continue;
               else list[i] = "";
        */

        if(pos > 0 && pos < 6){
            for(int i = 0; i < list.length; i++){
                if(list[i].charAt(pos-1) != ch)
                    list[i] = "";
            }
        }else if(pos == 0){
            for(int i = 0; i < list.length; i++){
                if(list[i].indexOf(ch) == -1)
                    list[i] = "";
            }
        }else if(pos == -1){
            for(int i = 0; i < list.length; i++){
